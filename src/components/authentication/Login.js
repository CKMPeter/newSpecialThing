            ...
            <div ref = {loginRef} class="logIn">
                <CenteredContainer>
                        ...
                        <div class= "otherLogin">
                            <Button onClick={handleGoole} disabled={loading} className="w-100 mt-3 fw-bold" type= "submit" style={{backgroundColor: '#578FCA', borderStyle: 'none'}}>
